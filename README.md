...
| 6 | ju 10-sep | Regresión logística: una respuesta que es sí o no, la recta dentro de una sigmoide, cómo se lee e^b, el summary con varias variables y dummies. Clasificar: umbral, matriz de confusión, falsos positivos y negativos, sensibilidad y especificidad, curva ROC, y evaluar fuera de la muestra. [Guía de lectura de las slides](apuntes/clase06_regresion_logistica.md) ([PDF](apuntes/clase06_regresion_logistica.pdf)). Datos: clientes de tarjeta de crédito (James et al.) y pasajeros del Titanic, en `datos/clase06/` | [PDF](presentaciones/clase06_regresion_logistica.pdf) | [notebook](06_regresion_logistica.ipynb) | [abrir en Colab](https://colab.research.google.com/github/daniopitz/diplomado-cdd/blob/main/06_regresion_logistica_colab.ipynb) |
| 7 | ma 15-sep | Regresión regularizada (Ridge y Lasso) para modelos con muchas variables | | | |
