...
| 5 | ma 08-sep | Fundamentos de probabilidad: variables aleatorias y distribuciones. Nociones de inferencia estadística: distribución muestral, error estándar, intervalos de confianza, pruebas de hipótesis, valor p y bootstrap. [Guía de lectura de las slides](apuntes/clase05_probabilidad_inferencia.md) ([PDF](apuntes/clase05_probabilidad_inferencia.pdf)) | [PDF](presentaciones/clase05_probabilidad_inferencia.pdf) | [notebook](05_probabilidad_inferencia.ipynb) | [abrir en Colab](https://colab.research.google.com/github/daniopitz/diplomado-cdd/blob/main/05_probabilidad_inferencia_colab.ipynb) |
| 6 | ju 10-sep | Regresión lineal en profundidad: diagnósticos con los residuos y evaluación fuera de la muestra. Regresión logística para clasificar | | | |
