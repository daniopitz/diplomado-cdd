...
| 7 | ma 15-sep | Clasificación, continuación: sensibilidad y especificidad, cómo elegir el umbral según el costo de cada error y la curva ROC. Regresión regularizada (Ridge y Lasso) para modelos con muchas variables | | | |
