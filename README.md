...
| 5 | ma 08-sep | Fundamentos de probabilidad: variables aleatorias y distribuciones. Nociones de inferencia estadística: distribución muestral, error estándar, intervalos de confianza, pruebas de hipótesis, valor p y bootstrap. [Guía de lectura de las slides](apuntes/clase05_probabilidad_inferencia.md) ([PDF](apuntes/clase05_probabilidad_inferencia.pdf)). En el notebook: la regresión simple y múltiple pendiente de la clase 4 (dummies y R² ajustado incluidos), el bootstrap de la pendiente y la lectura completa del summary | [PDF](presentaciones/clase05_probabilidad_inferencia.pdf) | [notebook](05_probabilidad_inferencia.ipynb) | [abrir en Colab](https://colab.research.google.com/github/daniopitz/diplomado-cdd/blob/main/05_probabilidad_inferencia_colab.ipynb) |
| 6 | ju 10-sep | Regresión logística: una respuesta que es sí o no, la recta dentro de una sigmoide, lectura del summary y clasificación | | | |
...
| [Primer análisis exploratorio de datos](evaluaciones/eda_capstone.md) (40%) | **lu 15-sep** | [publicada](evaluaciones/rubricas/rubrica_eda_capstone.md) (mié 02-sep) | |
