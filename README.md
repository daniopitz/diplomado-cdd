...
|-----------|---------|--------------------|--------------|
| Formulación del proyecto Capstone (30%) | **lu 07-sep** | [publicada](evaluaciones/rubricas/rubrica_formulacion_capstone.md) (ju 27-ago, clase 2) | idea de cada equipo: ju 03-sep (clase 4) |
